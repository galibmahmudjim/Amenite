...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    Context context;
    ArrayList<AppoinmentList> appoinmentArrayLists;

    public MyAdapter(Context context, ArrayList<AppoinmentList> appoinmentArrayLists) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.MyViewHolder holder, int position) {
        ...
        AppoinmentList appoinmentList = appoinmentArrayLists.get(position);
